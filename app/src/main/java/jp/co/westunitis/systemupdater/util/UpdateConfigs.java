...
public final class UpdateConfigs {
    ...
    public static final String UPDATE_CONFIGS_ROOT = "SystemImg/";
    ...
    public static String getConfigsRoot(Context context) {
        return Paths
                .get(context.getExternalFilesDir(null).toString(), UPDATE_CONFIGS_ROOT)
                .toString();
    }
    ...
    public static List<UpdateConfig> getUpdateConfigs(Context context) {
        ...
        for (final File f : root.listFiles()) {
            if (!f.isDirectory() && f.getName().endsWith(".zip")) {
                LogUtil.d("UpdateConfigs:", "found " + f.getPath());
                configs.add(UpdateConfig.fromZip(f));
            }
        }
        return configs;
    }
