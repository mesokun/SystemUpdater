...
package jp.co.westunitis.systemupdater.ui;
...
public class MainActivity extends Activity {
    ...
    private TextView mTextViewNeckbandVersion;
    private TextView mTextViewHmdVersion;
    ...
    private HmdUpdateManager mHmdUpdateManager;
    private String mNeckVersion;
    private int mHmdVersion;

//    public class HmdUpdateCallback extends HmdUpdateManager.HmdUpdateStatusCallback {
//        @Override
//        public void onServiceStateChanged(boolean connected) {
//            super.onServiceStateChanged(connected);
//            Log.d(TAG, "onServiceStateChanged : " + connected);
//        }
//
//        @Override
//        public void onHmdUpdateStatusChanged(int status) {
//            super.onHmdUpdateStatusChanged(status);
//            Log.d(TAG, "onHmdUpdateStatusChanged : " + status);
//        }
//    }
//    HmdUpdateCallback mHmdUpdateCallback = new HmdUpdateCallback();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DeviceInfoUtil.isInfoLinker()) {
            mHmdUpdateManager = HmdUpdateManager.getInstance(getApplicationContext(),
                    null);
        }

        this.mTextViewBuild = findViewById(R.id.textViewBuild);
        this.mTextViewNeckbandVersion = findViewById(R.id.textViewNeckbandVersion);
        this.mTextViewHmdVersion = findViewById(R.id.textViewHmdVersion);
    ...
    /**
     * get current version is clicked
     */
    public void onGetVersionClick(View view) {
        if (DeviceInfoUtil.isInfoLinker()) {
            mNeckVersion = mHmdUpdateManager.getNeckBandVersion();
            mHmdVersion = mHmdUpdateManager.getHmdVersion();
            String currentNeckVer = "Neckband Version: " + mNeckVersion;
            String currentHmdVer = "HMD Version: " + mHmdVersion;
            mTextViewNeckbandVersion.setText(currentNeckVer);
            mTextViewHmdVersion.setText(currentHmdVer);
        }
    }
